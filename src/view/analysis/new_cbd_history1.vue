<template>
  <div class="box">
    ...
    <div class="tab_left" v-if="!loading">
      <button class="button_two button_one">分布规律</button>
      <button class="button_two" @click="two">紧缺分析</button>
...
export default {
  ...
  created() {
    this.url =
      "https://datav.aliyuncs.com/share/408f9a9f3036652735091a94f72a28cf?timestamp=" +
      new Date().getTime();
  },
  methods: {
    two() {
