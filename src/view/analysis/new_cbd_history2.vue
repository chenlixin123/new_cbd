<template>
  <div class="box">
    ...
    <div class="tab_left" v-if="!loading">
      <button class="button_two" @click="one">分布规律</button>
      <button class="button_two button_one">紧缺分析</button>
      <button class="button_two" @click="three">全年车流</button>
    </div>
...
export default {
  ...
  created() {
    this.url =
      "https://datav.aliyuncs.com/share/eb9226c732a0bfbf8a0753953500d431?timestamp=" +
      new Date().getTime();
  },
  methods: {
    one() {
